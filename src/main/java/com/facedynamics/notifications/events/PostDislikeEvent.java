...
@Getter
public class PostDislikeEvent extends ApplicationEvent {

    private final NotificationDto receivedDTO;
    private final NotificationUserServiceDTO ownerDTO;

    public PostDislikeEvent(Object source, NotificationDto receivedDTO, NotificationUserServiceDTO ownerDTO) {
        super(source);
