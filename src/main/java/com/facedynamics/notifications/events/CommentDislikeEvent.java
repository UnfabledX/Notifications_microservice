...
@Getter
public class CommentDislikeEvent extends ApplicationEvent {

    private final NotificationDto receivedDTO;
    private final NotificationUserServiceDTO ownerDTO;

    public CommentDislikeEvent(Object source, NotificationDto receivedDTO, NotificationUserServiceDTO ownerDTO) {
        super(source);
